...
public class ListerResultat extends Outils{
	private JTable table;
	public ListerResultat(){
		...
		Connection conn;
    	String requete = "Select * From Regate Where estTerminé = true";
		try {
		...
		JButton btnInscrire = new JButton("R\u00E9sultat");
		btnInscrire.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new Resultats((String)table.getValueAt(table.getSelectedRow(), 3));
			}
		});
